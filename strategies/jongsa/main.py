# -*- coding: utf-8 -*-
"""
종사종팔 v1 - FastAPI 서버 + 스케줄러
(떨사오팔 ddsop 복제. 매수만 종가 MOC 무조건 — trading_logic 참조. 스케줄은 jongsa 레인)
"""
import logging
...
from core.schedule_map import (
    ...
    JONGSA_WORKER_MIN_OFFSET as DDSOP_WORKER_MIN_OFFSET,
    JONGSA_PRE_AUTH_LEAD_MIN as DDSOP_PRE_AUTH_LEAD_MIN,
    JONGSA_SYNC_MINUTE as DDSOP_SYNC_MINUTE,
    JONGSA_SYNC_SECOND as DDSOP_SYNC_SECOND,
)
